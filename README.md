...
- Cyber cafes and service centers
- Medical shops and clinics
- Any shop owner who wants to understand customer footfall and engagement patterns
...
- Live footfall count displayed on screen at all times
- Instant alert sent to phone when crowd count gets high
- Shows exact number of people detected in the frame
- Helps identify peak hours and customer engagement patterns
- 5-minute cooldown so alerts do not spam
- Threshold is adjustable. Default is set to 10 persons
...
4. If count exceeds threshold, an instant alert is sent to the owner's phone with the exact number of people detected.
5. Cooldown timer prevents repeated alerts.
6. Over time, shop owners can track which hours see the most footfall and plan accordingly.
...
Originally built for Skyline Shop, Badarpur, Delhi. Made open source so any shop owner can use it.
```
